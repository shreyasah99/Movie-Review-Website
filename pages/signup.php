...
if(isset($_POST['create'])){
	...
	if($num>=1){
		echo "<script> alert('$email already exists! Please try another email')";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="C:\xampp\htdocs\movies\css\pages\signup.css">
	...
	<div class="container-fluid d1">
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 col-xs-12 div1">
				...
				<h1 class="heading1"></h1><a href="index.php"></a></h1>
				<br>
				<br>
				<form class="form-container" method="post">
					<div class="form-group">
						<img class="imglg" src="../assets/logo.jpg" height=200px>
					</div>
					<div class="form-group">
